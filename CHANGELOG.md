...
See [Decoupling Backup and Restore Logic from Etcd Operator](https://github.com/beekhof/rss-operator/issues/1626) for more detail.
...
Check https://github.com/beekhof/rss-operator/blob/master/doc/user/upgrade/upgrade_guide.md#v02x-to-v03x
...
- TLS feature: user can now create TLS-secured cluster via operator.
  See [TLS guide](https://github.com/beekhof/rss-operator/blob/master/doc/user/cluster_tls.md).
