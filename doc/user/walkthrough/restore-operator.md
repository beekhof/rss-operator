...
3. Verify that the etcd-restore-operator creates the `EtcdRestore` CRD:
    ...
    $ kubectl get crd
    NAME                                       KIND
    etcdclusters.galera.db.beekhof.net      CustomResourceDefinition.v1beta1.apiextensions.k8s.io
    etcdrestores.galera.db.beekhof.net      CustomResourceDefinition.v1beta1.apiextensions.k8s.io
    ```
...
2. Verify the `EtcdCluster` CR for the restored cluster:
    ...
    NAME                    KIND
    restored-etcd-cluster   EtcdCluster.v1beta2.galera.db.beekhof.net
    ```
